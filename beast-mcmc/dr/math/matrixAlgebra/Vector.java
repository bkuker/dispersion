...
public class Vector {
	...
	public Vector(int dimension) throws NegativeArraySizeException {
		if (dimension <= 0)
			throw new NegativeArraySizeException("Requested vector size: " + dimension);
	...
	public void accumulate(double[] x) throws IllegalDimension {
		if (this.dimension() != x.length)
			throw new IllegalDimension("Attempt to add a " + this.dimension() + "-dimension vector to a " + x.length
					+ "-dimension array");
	...
	public void accumulate(Vector v) throws IllegalDimension {
		if (this.dimension() != v.dimension())
			throw new IllegalDimension("Attempt to add a " + this.dimension() + "-dimension vector to a "
	...
	public double product(Vector v) throws IllegalDimension {
		...
		if (components.length != n)
			throw new IllegalDimension("Dot product with mismatched dimensions: " + components.length + ", " + n);
	...
	public Vector product(Matrix a) throws IllegalDimension {
		...
		int m = a.columns();
		if (this.dimension() != n)
			throw new IllegalDimension("Product error: transposed of a " + this.dimension()
					+ "-dimension vector cannot be multiplied with a " + n + " by " + m + " matrix");
